...
public static void glp_ios_terminate(glp_tree T) {
  ...
  public static int glp_gmi_cut(glp_prob P, int j, SWIGTYPE_p_int ind, SWIGTYPE_p_double val, SWIGTYPE_p_double phi) {
    return GLPKJNI.glp_gmi_cut(glp_prob.getCPtr(P), P, j, SWIGTYPE_p_int.getCPtr(ind), SWIGTYPE_p_double.getCPtr(val), SWIGTYPE_p_double.getCPtr(phi));
  }

  public static int glp_gmi_gen(glp_prob P, glp_prob pool, int max_cuts) {
    return GLPKJNI.glp_gmi_gen(glp_prob.getCPtr(P), P, glp_prob.getCPtr(pool), pool, max_cuts);
  }

  public static SWIGTYPE_p_glp_mir glp_mir_init(glp_prob P) {
    long cPtr = GLPKJNI.glp_mir_init(glp_prob.getCPtr(P), P);
    return (cPtr == 0) ? null : new SWIGTYPE_p_glp_mir(cPtr, false);
  }

  public static int glp_mir_gen(glp_prob P, SWIGTYPE_p_glp_mir mir, glp_prob pool) {
    return GLPKJNI.glp_mir_gen(glp_prob.getCPtr(P), P, SWIGTYPE_p_glp_mir.getCPtr(mir), glp_prob.getCPtr(pool), pool);
  }

  public static void glp_mir_free(SWIGTYPE_p_glp_mir mir) {
    GLPKJNI.glp_mir_free(SWIGTYPE_p_glp_mir.getCPtr(mir));
  }

  public static SWIGTYPE_p_glp_cfg glp_cfg_init(glp_prob P) {
    long cPtr = GLPKJNI.glp_cfg_init(glp_prob.getCPtr(P), P);
    return (cPtr == 0) ? null : new SWIGTYPE_p_glp_cfg(cPtr, false);
  }

  public static void glp_cfg_free(SWIGTYPE_p_glp_cfg G) {
    GLPKJNI.glp_cfg_free(SWIGTYPE_p_glp_cfg.getCPtr(G));
  }

  public static int glp_clq_cut(glp_prob P, SWIGTYPE_p_glp_cfg G, SWIGTYPE_p_int ind, SWIGTYPE_p_double val) {
    return GLPKJNI.glp_clq_cut(glp_prob.getCPtr(P), P, SWIGTYPE_p_glp_cfg.getCPtr(G), SWIGTYPE_p_int.getCPtr(ind), SWIGTYPE_p_double.getCPtr(val));
  }
