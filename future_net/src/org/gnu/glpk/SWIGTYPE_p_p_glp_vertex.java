 ...
 */
public class SWIGTYPE_p_p_glp_vertex {
  private transient long swigCPtr;

  protected SWIGTYPE_p_p_glp_vertex(long cPtr, @SuppressWarnings("unused") boolean futureUse) {
    swigCPtr = cPtr;
  }

  protected SWIGTYPE_p_p_glp_vertex() {
    swigCPtr = 0;
  }

  protected static long getCPtr(SWIGTYPE_p_p_glp_vertex obj) {
