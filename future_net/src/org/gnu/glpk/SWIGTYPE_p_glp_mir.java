 ...
 */
public class SWIGTYPE_p_glp_mir {
  private transient long swigCPtr;

  protected SWIGTYPE_p_glp_mir(long cPtr, @SuppressWarnings("unused") boolean futureUse) {
    swigCPtr = cPtr;
  }

  protected SWIGTYPE_p_glp_mir() {
    swigCPtr = 0;
  }

  protected static long getCPtr(SWIGTYPE_p_glp_mir obj) {
