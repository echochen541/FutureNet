 ...
 */
public class SWIGTYPE_p_glp_cfg {
  private transient long swigCPtr;

  protected SWIGTYPE_p_glp_cfg(long cPtr, @SuppressWarnings("unused") boolean futureUse) {
    swigCPtr = cPtr;
  }

  protected SWIGTYPE_p_glp_cfg() {
    swigCPtr = 0;
  }

  protected static long getCPtr(SWIGTYPE_p_glp_cfg obj) {
