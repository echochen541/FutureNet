...
/**
 * The intermediary JNI class. Loads the native library.
 */
public class GLPKJNI {
	...
	static {
		try {
			if (System.getProperty("os.name").toLowerCase().contains("windows")) {
				...
				try {
					System.loadLibrary("glpk_4_59");
				} catch (UnsatisfiedLinkError e) {
					// The dependent library might be in the OS library search
					// path.
				}

				System.loadLibrary("glpk_4_59_java");
			} else {
				// try to load Linux library

				try {
					System.load(FileUtil.getAppPath(Main.class) + "/lib/libglpk.so");
				} catch (UnsatisfiedLinkError e) {
					// The dependent library might be in the OS library search
					// path.
				}

				System.load(FileUtil.getAppPath(Main.class) + "/lib/libglpk_java.so");
			}
		} catch (UnsatisfiedLinkError e) {
			/**
			 * Information string.
	...
	public final static native void glp_iocp_sr_heur_set(long jarg1, glp_iocp jarg1_, int jarg2);

	public final static native int glp_iocp_sr_heur_get(long jarg1, glp_iocp jarg1_);
	...
	public final static native void glp_set_row_bnds(long jarg1, glp_prob jarg1_, int jarg2, int jarg3, double jarg4,
			double jarg5);

	public final static native void glp_set_col_bnds(long jarg1, glp_prob jarg1_, int jarg2, int jarg3, double jarg4,
			double jarg5);

	public final static native void glp_set_obj_coef(long jarg1, glp_prob jarg1_, int jarg2, double jarg3);

	public final static native void glp_set_mat_row(long jarg1, glp_prob jarg1_, int jarg2, int jarg3, long jarg4,
			long jarg5);

	public final static native void glp_set_mat_col(long jarg1, glp_prob jarg1_, int jarg2, int jarg3, long jarg4,
			long jarg5);

	public final static native void glp_load_matrix(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, long jarg4,
			long jarg5);
	...
	public final static native void glp_check_kkt(long jarg1, glp_prob jarg1_, int jarg2, int jarg3, long jarg4,
			long jarg5, long jarg6, long jarg7);
	...
	public final static native int glp_print_ranges(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, int jarg4,
			String jarg5);
	...
	public final static native int glp_prim_rtest(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, long jarg4,
			int jarg5, double jarg6);

	public final static native int glp_dual_rtest(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, long jarg4,
			int jarg5, double jarg6);

	public final static native void glp_analyze_bound(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, long jarg4,
			long jarg5, long jarg6);

	public final static native void glp_analyze_coef(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, long jarg4,
			long jarg5, long jarg6, long jarg7, long jarg8);
	...
	public final static native void glp_ios_row_attr(long jarg1, glp_tree jarg1_, int jarg2, long jarg3,
			glp_attr jarg3_);

	public final static native int glp_ios_pool_size(long jarg1, glp_tree jarg1_);

	public final static native int glp_ios_add_row(long jarg1, glp_tree jarg1_, String jarg2, int jarg3, int jarg4,
			int jarg5, long jarg6, long jarg7, int jarg8, double jarg9);
	...
	public final static native int glp_gmi_cut(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, long jarg4,
			long jarg5);

	public final static native int glp_gmi_gen(long jarg1, glp_prob jarg1_, long jarg2, glp_prob jarg2_, int jarg3);

	public final static native long glp_mir_init(long jarg1, glp_prob jarg1_);

	public final static native int glp_mir_gen(long jarg1, glp_prob jarg1_, long jarg2, long jarg3, glp_prob jarg3_);

	public final static native void glp_mir_free(long jarg1);

	public final static native long glp_cfg_init(long jarg1, glp_prob jarg1_);

	public final static native void glp_cfg_free(long jarg1);

	public final static native int glp_clq_cut(long jarg1, glp_prob jarg1_, long jarg2, long jarg3, long jarg4);

	public final static native void glp_init_mpscp(long jarg1, glp_mpscp jarg1_);

	public final static native int glp_read_mps(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, glp_mpscp jarg3_,
			String jarg4);

	public final static native int glp_write_mps(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, glp_mpscp jarg3_,
			String jarg4);
	...
	public final static native int glp_write_lp(long jarg1, glp_prob jarg1_, long jarg2, glp_cpxcp jarg2_,
			String jarg3);
	...
	public final static native void glp_mpl_init_rand(long jarg1, glp_tran jarg1_, int jarg2);
	...
	public final static native int glp_mpl_postsolve(long jarg1, glp_tran jarg1_, long jarg2, glp_prob jarg2_,
			int jarg3);
	...
	public final static native int glp_at_error();
	...
	public final static native double glp_time();

	public final static native double glp_difftime(double jarg1, double jarg2);
	...
	public final static native void glp_mincost_lp(long jarg1, glp_prob jarg1_, long jarg2, glp_graph jarg2_, int jarg3,
			int jarg4, int jarg5, int jarg6, int jarg7);

	public final static native int glp_mincost_okalg(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			int jarg5, long jarg6, int jarg7, int jarg8);

	public final static native int glp_mincost_relax4(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			int jarg5, int jarg6, long jarg7, int jarg8, int jarg9);

	public final static native void glp_maxflow_lp(long jarg1, glp_prob jarg1_, long jarg2, glp_graph jarg2_, int jarg3,
			int jarg4, int jarg5, int jarg6);

	public final static native int glp_maxflow_ffalg(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			long jarg5, int jarg6, int jarg7);
	...
	public final static native int glp_asnprob_lp(long jarg1, glp_prob jarg1_, int jarg2, long jarg3, glp_graph jarg3_,
			int jarg4, int jarg5, int jarg6);

	public final static native int glp_asnprob_okalg(int jarg1, long jarg2, glp_graph jarg2_, int jarg3, int jarg4,
			long jarg5, int jarg6);
	...
	public final static native int glp_read_mincost(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			int jarg5, String jarg6);

	public final static native int glp_write_mincost(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			int jarg5, String jarg6);

	public final static native int glp_read_maxflow(long jarg1, glp_graph jarg1_, long jarg2, long jarg3, int jarg4,
			String jarg5);

	public final static native int glp_write_maxflow(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			String jarg5);
	...
	public final static native int glp_netgen(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			long jarg5);

	public final static native void glp_netgen_prob(int jarg1, long jarg2);

	public final static native int glp_gridgen(long jarg1, glp_graph jarg1_, int jarg2, int jarg3, int jarg4,
			long jarg5);

	public final static native int glp_rmfgen(long jarg1, glp_graph jarg1_, long jarg2, long jarg3, int jarg4,
			long jarg5);
