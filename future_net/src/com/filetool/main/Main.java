...
public class Main {
	public static void main(String[] args) {
		...
		String graphFilePath = System.getProperty("user.dir").replaceAll("\\\\", "/") + "/test/case4/topo.csv";
		String conditionFilePath = System.getProperty("user.dir").replaceAll("\\\\", "/") + "/test/case4/demand.csv";
		String resultFilePath = System.getProperty("user.dir").replaceAll("\\\\", "/") + "/test/case4/result.csv";
